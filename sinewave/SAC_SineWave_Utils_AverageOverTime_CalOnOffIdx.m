...
stim_dur_use = 4.5; % do not use the full 5 second. do not like the ramping up at the onset of the stimulus.
...
if ~set_integrate_len
    ...
    if isempty(f_vals)
        error('You need to provide f_vals. If this is not sinewave sweeps, Do not use this function');
    end
